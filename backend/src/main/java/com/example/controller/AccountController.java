...
public class AccountController {
    ...
    @GetMapping("/privacy")
    public RestBean<AccountPrivacyVO> privacy(@RequestAttribute(name = Const.ATTR_USER_ID) int id){
        AccountPrivacy privacy = privacyService.getPrivacyById(id);
        return RestBean.success(privacy.asViewObject(AccountPrivacyVO.class));
    }
    @PostMapping("/save-privacy")
    public RestBean<Void> savePrivacy(@RequestAttribute(name = Const.ATTR_USER_ID) int id,
